package com.springboot.yatrii.request;

import java.util.HashSet;
import java.util.Set;

import com.springboot.yatrii.model.Size;
...
public class CreateProductRequest {
	...
	public CreateProductRequest(String title, String description, int price, int discountedPrice, int discountPercent,
			...
			String secondLevelCategory, String thirdLevelCategory, double latitude, double longitude) {
		super();
		this.title = title;
