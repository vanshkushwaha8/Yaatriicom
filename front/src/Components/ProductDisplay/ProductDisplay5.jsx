      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Kochi</p>
            <p><strong>Description:</strong>Experience the serene backwaters of Alleppey and rejuvenate at the lush tea plantations of Munnar.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay5
