      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Kolkata</p>
            <p><strong>Description:</strong>Immerse yourself in the cultural vibrancy of Victoria Memorial and taste street food in Park Street.</p>
            <DurationSelector/>
            <TransportSelector/>
