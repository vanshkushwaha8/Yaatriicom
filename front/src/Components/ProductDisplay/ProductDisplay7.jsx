      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Shimla</p>
            <p><strong>Description:</strong>Take a heritage walk on the Mall Road and enjoy panoramic views from Jakhu Hill.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay7
