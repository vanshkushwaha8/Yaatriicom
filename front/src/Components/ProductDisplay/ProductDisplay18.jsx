      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Mussoorie</p>
            <p><strong>Description:</strong>Delight in the scenic beauty of Kempty Falls and take a cable car ride to Gun Hill for breathtaking views of the Himalayas.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay18
