      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Amritsar</p>
            <p><strong>Description:</strong>Visit the Golden Temple and witness the patriotic fervor at Wagah Border ceremony.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay4
