      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Manali</p>
            <p><strong>Description:</strong>Experience the thrill of adventure sports in Solang Valley and explore the scenic beauty of Rohtang Pass.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay17
