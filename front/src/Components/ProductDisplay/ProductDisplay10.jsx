      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Description:</strong>Explore the fascinating Bhimbetka rock shelters and visit the beautiful Upper Lake.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay10
