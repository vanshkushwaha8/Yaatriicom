      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Jaisalmer</p>
            <p><strong>Description:</strong>Explore the majestic Jaisalmer Fort and go on a camel safari in the Thar Desert.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay19
