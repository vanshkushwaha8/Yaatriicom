      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Ayodhya</p>
            <p><strong>Description:</strong>Visit the revered Ram Janmabhoomi temple site and explore the spiritual significance of Hanuman Garhi.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay13
