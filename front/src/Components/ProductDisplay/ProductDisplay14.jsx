      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Rishikesh</p>
            <p><strong>Description:</strong>Engage in spiritual retreats and adventure sports amidst the serene Himalayan backdrop.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay14
