      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Durgapur</p>
            <p><strong>Description:</strong>Discover the steel industry at the Durgapur Barrage and explore Troika Park.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay12
