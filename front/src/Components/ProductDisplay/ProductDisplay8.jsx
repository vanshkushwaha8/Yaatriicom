      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Darbhanga</p>
            <p><strong>Description:</strong>Visit the Raj Darbhanga Palace for its grandeur and explore the ancient temples.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay8
