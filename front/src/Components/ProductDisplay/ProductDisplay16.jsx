      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Nainital</p>
            <p><strong>Description:</strong>Enjoy boating on the picturesque Naini Lake and take a cable car ride to Snow View Point for panoramic views of the Himalayas.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay16
