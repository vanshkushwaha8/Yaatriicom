      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Srinagar</p>
            <p><strong>Description:</strong>Take a shikara ride on Dal Lake and explore the Mughal Gardens.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay6
