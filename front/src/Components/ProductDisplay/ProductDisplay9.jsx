      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> Chhattarpur</p>
            <p><strong>Description:</strong>Explore the historical Chhattarpur Temple and the nearby Qutub Minar.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay9
