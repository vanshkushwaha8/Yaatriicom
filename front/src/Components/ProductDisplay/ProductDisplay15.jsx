      ...
      <div className="product-detailS">
        ...
        <button>Give Review</button>
          ...
          <div className="package-details">
            ...
            <p><strong>Destination:</strong> GOA</p>
            <p><strong>Description:</strong>Relax on the pristine beaches and party at the lively nightclubs.</p>
            <DurationSelector/>
            <TransportSelector/>
...
export default ProductDisplay15
