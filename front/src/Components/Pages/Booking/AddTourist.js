...
const AddTourist = () => {
	...
	let handleSubmit = (event) => {
		...
		axios
			.post('http://localhost:9090/yatrii/booking/createBooking/tour/' + tourId + '/user/' + user, requestObject)
...
// 		axios
//     .post(`http://localhost:9090/yatrii/booking/createBooking/tour/${tourId}/user/${user}` + tourId + '/user/' + user, requestObject)
//     .then((response) => {
//       // Handle response
//     })
//     .catch((error) => {
...
//   axios
//     .post(`http://localhost:9090/api/book/user/2/train/${selectedTrain}/addBooking/`  + selectedTrain + '/addBooking/', requestObject)
//     .then((response) => {
//       // Handle response
//     })
//     .catch((error) => {
